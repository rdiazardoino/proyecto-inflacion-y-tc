...
DERIVADAS = [
    ...
    dict(var_id="ims_general_idx",
         nombre="IMS general (indice, desde ene-1968, base jul-2008=100)",
         frecuencia="M", fuente="INE",
         transformacion="pct_m,pct_yoy",
         hipotesis_econ="Serie larga de salarios para contexto; la operativa es salario_nominal_ims (IMSN).",
         modelo_destino="inflacion", prioridad="importante"),
